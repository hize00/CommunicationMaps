        ...
        while not success:
            ...
            if state == GoalStatus.SUCCEEDED:
                ...
                if round <=3:
                    ...
                    elif 13 <=count < 20: #I try 8 times to fix a position manually, if it is not enough I fix again coords changing them a little
                        rospy.loginfo(str(self.robot_id) + ' - fixing again manually') #Very rare, needed only if two robots have to stop in the same point
                        if i > 1:
                            i = i + 1
                        elif 0 < i < 1:
                            i = i + 0.2
