...
# Parameters for real robots.
#gflags.DEFINE_string("strategy_for_test_set", "max_variance",
#    "Datasets used to test error in case of real robots.")
#gflags.DEFINE_integer("num_test_set_runs", 1,
#    "Number of repetitions for the test set.")
#STRATEGY_FOR_TEST_SET = 'max_variance'
#NUM_TEST_SET_RUNS = 1
...
#plot_format = {'max_variance': ['g:o', 'PM'], 
#    'max_variance_itu': ['b--s', 'PM-ITU']}
#strategies = ["max_variance", "max_variance_itu"]

# PLOT Parameters. # TODO more flexible instead of changing it here.
#strategies = ["random", "max_variance", "multi2-2", "multi2-4"] #"multi2-6"]
#strategies = {}

#strategies[2] = ["max_variance", "random", "multi2-2"]
...
def plot(environment, num_robots, comm_model_path,
    granularity, mission_duration):
    ...
    cur_rmse_values_run = None
    cur_rvar_values_run = None
    ...
    for stamp in range(len(x)):
        ...
        if stamp == range(len(x))[-1]:
            cur_rmse_values_run = cur_rmse_values
            cur_rvar_values_run = cur_rvar_values
            print cur_rmse_values_run
            print cur_rvar_values_run

    print "P-value RMSE:"
    compute_p_values(cur_rmse_values_run, cur_rmse_values_run)

    print "P-value STD DEV:"
    compute_p_values(cur_rvar_values_run, cur_rvar_values_run)
...
def evaluate(environment, num_robots, num_runs, is_simulation,
    ...
    environment_yaml_path = "/home/andrea/catkin_ws/src/strategy/envs/" + environment + '.yaml'
