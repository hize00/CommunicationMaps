...
gflags.DEFINE_integer("granularity", 350, "Granularity of the mission (seconds) to plot every granularity.")
gflags.DEFINE_integer("mission_duration", 3500, "Mission duration (seconds).")
