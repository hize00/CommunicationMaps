...
The maps are taken from the paper 'CONSTRUCTING RADIO SIGNAL STRENGTH MAPS WITH MULTIPLE ROBOT'
...
def number_of_moves(graph, vertex1, vertex2):
	if find_shortest_path(graph, vertex1, vertex2) == None:
		count = 9999999
	else : count = len(find_shortest_path(graph, vertex1, vertex2))-1 #subtract 1 otherwise for the movements of 1-2-3-4 we would have a cost of 4 instead of 3
	return count
