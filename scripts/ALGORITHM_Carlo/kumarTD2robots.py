...
if obj_fun == "time":
	...
	tS = min(max(shortest_matrix[STARTING_POS[0]][stpL[0]] , shortest_matrix[STARTING_POS[1]][stpL[1]]), max(shortest_matrix[STARTING_POS[0]][stpL[1]] , shortest_matrix[STARTING_POS[1]][stpL[0]]))
	...
	tF = min(max(shortest_matrix[STARTING_POS[0]][tour_configuration[-1][0]] , shortest_matrix[STARTING_POS[1]][tour_configuration[-1][1]]), max(shortest_matrix[STARTING_POS[0]][tour_configuration[-1][1]] , shortest_matrix[STARTING_POS[1]][tour_configuration[-1][0]]))
	...
	dS = min((shortest_matrix[STARTING_POS[0]][stpL[0]] + shortest_matrix[STARTING_POS[1]][stpL[1]]), (shortest_matrix[STARTING_POS[0]][stpL[1]] + shortest_matrix[STARTING_POS[1]][stpL[0]]))
	print "\ndistance for moving from STARTING_POS to first point of the tour " 
	print str(STARTING_POS) + " ---> " + str(tour_configuration[0])+ " : " + str(dS)
	dF = min((shortest_matrix[STARTING_POS[0]][tour_configuration[-1][0]] + shortest_matrix[STARTING_POS[1]][tour_configuration[-1][1]]), (shortest_matrix[STARTING_POS[0]][tour_configuration[-1][1]] + shortest_matrix[STARTING_POS[1]][tour_configuration[-1][0]]))
	print "distance for moving from last point of the tour to STARTING_POS " 
	print str(tour_configuration[-1]) + " ---> " + str(STARTING_POS)+ " : " + str(dF)
	dEND = t + dS + dF
	print "\n\nTOTAL DISTANCE: " + str(dEND)
